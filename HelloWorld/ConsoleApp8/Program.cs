...
{
    enum Day1 { Monday, Thesday, Wendnesday, Thursday, Friday, Saturday, Sunday }
    enum Day2 : byte { Monday = 11, Thesday, Wendnesday, Thursday, Friday, Saturday, Sunday = Monday + 100 }
    class Program
    {
